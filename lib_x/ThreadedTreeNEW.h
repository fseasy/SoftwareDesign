#ifndef THREADEDTREENEW_H_INCLUDED
#define THREADEDTREENEW_H_INCLUDED
#include "QUEUE.h"
/**
    **数据结构：线索树
    **实现方式：链表（使用原来为NULL的指针指向节点中序遍历的前一个和后一个节点）
    **实现操作：线索化二叉树（先，中，后）；线索二叉树遍历
*/
template <class type>
class Node
{
...
#endif // THREADEDTREENEW_H_INCLUDED
